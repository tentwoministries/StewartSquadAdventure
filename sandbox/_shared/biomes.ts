...
export const BOG_KEYFRAMES: Record<string, Keyframe> = {
  golden: {
    ...
    fog: { color: '#B08A6A', near: 19, far: 53, max: 0.65, height: 8 },
  ...
  dusk: {
    ...
    fog: { color: '#5A3E78', near: 15, far: 41, max: 0.75, height: 8 },
  ...
  night: {
    name: 'night', p: 0.78,
    key: { color: '#7A90D0', intensity: 0.6, elev: 35, azim: 130 },
    hemi: { sky: '#26308A', ground: '#0E2A22', intensity: 0.7 },
    fog: { color: '#2A2448', near: 14, far: 38, max: 0.8, height: 6 },
    sky: { zenith: '#06081E', horizon: '#1E2050', ground: '#101430', glow: 0.5 },
    cloud: '#242A50', stars: 1, moon: { on: true, elev: 35, azim: 130 }, exposure: 0.9,
  ...
  deep: {
    ...
    fog: { color: '#221C40', near: 13, far: 35, max: 0.85, height: 6 },
...
export const CAVE_KEYFRAMES: Record<string, Keyframe> = {
  dark: {
    ...
    fog: { color: '#100E24', near: 12, far: 48, max: 0.85, height: 40 },
  ...
  half: {
    ...
    hemi: { sky: '#34309A', ground: '#100E20', intensity: 0.34 },
    fog: { color: '#141230', near: 13, far: 52, max: 0.82, height: 40 },
    sky: { zenith: '#04030A', horizon: '#04030A', ground: '#04030A', glow: 0 },
    cloud: '#000000', stars: 0, moon: { on: false, elev: 0, azim: 0 }, exposure: 0.95,
  ...
  lit: {
    ...
    fog: { color: '#181640', near: 14, far: 58, max: 0.78, height: 40 },
    sky: { zenith: '#04030A', horizon: '#04030A', ground: '#04030A', glow: 0 },
